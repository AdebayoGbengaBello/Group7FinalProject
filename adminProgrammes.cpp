...
namespace Group7FinalProject {
	System::Void adminProgrammes::btnDepartments_Click(System::Object^ sender, System::EventArgs^ e)
	{
		this->Hide();
	...
	System::Void adminProgrammes::btnDashboard_Click(System::Object^ sender, System::EventArgs^ e)
	{
		this->Hide();
	...
	System::Void adminProgrammes::btnCourses_Click(System::Object^ sender, System::EventArgs^ e)
	{
		this->Hide();
	...
	System::Void adminProgrammes::btnFaculty_Click(System::Object^ sender, System::EventArgs^ e)
	{
		this->Hide();
	...
	System::Void adminProgrammes::btnStudents_Click(System::Object^ sender, System::EventArgs^ e)
	{
		this->Hide();
	...
	System::Void adminProgrammes::btnPayments_Click(System::Object^ sender, System::EventArgs^ e)
	{
		this->Hide();
	...
	System::Void adminProgrammes::btnEnrollment_Click(System::Object^ sender, System::EventArgs^ e)
	{
		this->Hide();
