...
//    //using namespace System::Drawing::Font;
//
//
...
//
//        int studentID;  // You set this when opening the form
//
...
//
//                String^ query =
//                    "SELECT courseCode, courseName, creditHours, grade, semester "
//                    "FROM Transcript WHERE studentID = @sid";
//
